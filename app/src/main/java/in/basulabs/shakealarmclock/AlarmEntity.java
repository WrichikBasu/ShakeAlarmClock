...
/**
 * A class with the {@link Entity} annotation representing the alarm table in the database. In this table,
 * {@link #alarmHour} and {@link #alarmMinutes} columns are defined to be compositely unique using the {@link
 * Index} annotation.
 */
...
public class AlarmEntity {
	...
	/**
	 * This key is auto-generated by {@link androidx.room.Room}. This id is used as {@code requestCode} while
	 * creating a {@link android.app.PendingIntent} for {@link android.app.AlarmManager}.
	 */
	...
	/**
	 * The snooze time in minutes, i.e. after how many minutes the alarm should repeat itself after being
	 * cancelled initially.
	 */
	public int snoozeTimeInMinutes;

	/**
	 * The snooze frequency, i.e. how many times the alarm should repeat itself after being cancelled
	 * initially.
	 */
	 ...
	 * {@link android.media.AudioManager#getStreamMaxVolume(int)}
	 * returns for the {@link android.media.AudioManager#STREAM_ALARM}.
	 */
	...
	/**
	 * The alarm type. Can only have the values {@link ConstantsAndStatics#ALARM_TYPE_SOUND_ONLY}, {@link
