...
public final class ConstantsAndStatics {
	 ...
	 * by the user.
	 */
	public static final String BUNDLE_KEY_ALARM_DETAILS = "in.basulabs.shakealarmclock" +
			".ALARM_DETAILS_BUNDLE";

	/**
	 * Bundle key for the alarm hour. The value is an integer.
	 */
	public static final String BUNDLE_KEY_ALARM_HOUR = "in.basulabs.shakealarmclock.ALARM_HOUR";

	public static final String BUNDLE_KEY_DATE_TIME = "in.basulabs.shakealarmclock.ALARM_DATE_TIME";

	/**
	 * Bundle key for the alarm minute. The value is an integer.
	 */
	public static final String BUNDLE_KEY_ALARM_MINUTE = "in.basulabs.shakealarmclock" +
			".ALARM_MINUTES";
	 ...
	 */
	public static final String BUNDLE_KEY_ALARM_TYPE = "in.basulabs.shakealarmclock.ALARM_TYPE";

	/**
	 * Bundle key for the alarm volume. The value is an integer.
	 */
	public static final String BUNDLE_KEY_ALARM_VOLUME = "in.basulabs.shakealarmclock.ALARM_VOLUME";

	/**
	 * Bundle key for the alarm snooze interval. The value is an integer.
	 */
	public static final String BUNDLE_KEY_SNOOZE_TIME_IN_MINS = "in.basulabs.shakealarmclock" +
			".SNOOZE_TIME_IN_MINS";

	/**
	 * Bundle key for the number of times the alarm should snooze itself. The value is an integer.
	 */
	public static final String BUNDLE_KEY_SNOOZE_FREQUENCY = "in.basulabs.shakealarmclock" +
			".SNOOZE_FREQUENCY";

	/**
	 * Bundle key denoting whether repeat is on or off. Value is boolean.
	 */
	public static final String BUNDLE_KEY_IS_REPEAT_ON = "in.basulabs.shakealarmclock.IS_REPEAT_ON";

	/**
	 * Bundle key denoting whether snooze is on or off. Value is boolean.
	 */
	public static final String BUNDLE_KEY_IS_SNOOZE_ON = "in.basulabs.shakealarmclock.IS_SNOOZE_ON";

	/**
	 * Bundle key denoting whether alarm is on or off. Value is boolean.
	 */
	public static final String BUNDLE_KEY_IS_ALARM_ON = "in.basulabs.shakealarmclock.IS_ALARM_ON";

	/**
	 * Bundle key for the alarm repeat days. The value is an ArrayList of Integer type. Monday is 1 and Sunday is 7.
	 */
	public static final String BUNDLE_KEY_REPEAT_DAYS = "in.basulabs.shakealarmclock.REPEAT_DAYS";
	 ...
	 */
	public static final String ACTION_DELIVER_ALARM = "in.basulabs.shakealarmclock.DELIVER_ALARM";

	/**
	 * The day on which the alarm is supposed to ring.
	 */
	public static final String BUNDLE_KEY_ALARM_DAY = "in.basulabs.shakealarmclock.ALARM_DAY";

	/**
	 * The month in which the alarm will ring.
	 */
	public static final String BUNDLE_KEY_ALARM_MONTH = "in.basulabs.shakealarmclock.ALARM_MONTH";

	/**
	 * The year in which the alarm will ring.
	 */
	public static final String BUNDLE_KEY_ALARM_YEAR = "in.basulabs.shakealarmclock.ALARM_YEAR";

	/**
	 * Bundle key for the personalised alarm message.
	 */
	public static final String BUNDLE_KEY_ALARM_MESSAGE = "in.basulabs.shakealarmclock" +
			".ALARM_MESSAGE";

	/**
	 * Bundle key for Uri of the alarm tone.
	 */
	public static final String BUNDLE_KEY_ALARM_TONE_URI = "in.basulabs.shakealarmclock" +
			".ALARM_TONE_URI";

	/**
	 * Bundle key: Indicates whether the user has explicitly chosen a date for that alarm.
	 */
	public static final String BUNDLE_KEY_HAS_USER_CHOSEN_DATE = "in.basulabs.shakealarmclock" +
			".HAS_USER_CHOSEN_DATE";
	 ...
	 */
	public static final String ACTION_SNOOZE_ALARM = "in.basulabs.shakealarmclock.SNOOZE_ALARM";
	 ...
	 */
	public static final String ACTION_CANCEL_ALARM = "in.basulabs.shakealarmclock.CANCEL_ALARM";
	 ...
	 */
	public static final String ACTION_NEW_ALARM = "in.basulabs.shakealarmclock.ACTION_NEW_ALARM";
	 ...
	 * "Add" button.
	 */
	public static final String ACTION_NEW_ALARM_FROM_INTENT = "in.basulabs.shakealarmclock" +
	 ...
	 */
	public static final String BUNDLE_KEY_OLD_ALARM_HOUR = "in.basulabs.shakealarmclock" +
			".OLD_ALARM_HOUR";
	 ...
	 */
	public static final String BUNDLE_KEY_OLD_ALARM_MINUTE = "in.basulabs.shakealarmclock" +
			".OLD_ALARM_MINUTE";

	/**
	 * Bundle key for the alarm ID.
	 */
	public static final String BUNDLE_KEY_ALARM_ID = "in.basulabs.shakealarmclock.OLD_ALARM_ID";

	/**
	 * Broadcast action: {@link Activity_RingAlarm} should now be destroyed.
	 */
	public static final String ACTION_DESTROY_RING_ALARM_ACTIVITY = "in.basulabs.shakealarmclock" +
	 ...
	 */
	public static final String SHARED_PREF_KEY_PERMISSION_WAS_ASKED_BEFORE = "in.basulabs" +
			".shakealarmclock" +
			".PERMISSION_WAS_ASKED_BEFORE";
	 ...
	 */
	public static final String SHARED_PREF_KEY_DEFAULT_SHAKE_OPERATION = "in.basulabs" +
			".shakealarmclock" +
	 ...
	 */
	public static final String SHARED_PREF_KEY_DEFAULT_POWER_BTN_OPERATION = "in.basulabs" +
			".shakealarmclock" +
	 ...
	 */
	public static final String SHARED_PREF_KEY_SHAKE_SENSITIVITY = "in.basulabs.shakealarmclock" +
			".SHAKE_SENSITIVITY";
	 ...
	 */
	public static final String SHARED_PREF_KEY_SHOW_BATTERY_OPTIM_DIALOG = "in.basulabs" +
			".shakealarmclock" +
			".SHOW_BATTERY_OPTIM_DIALOG";
	 ...
	 */
	public static final String SHARED_PREF_KEY_DEFAULT_SNOOZE_FREQ = "in.basulabs.shakealarmclock" +
	 ...
	 */
	public static final String SHARED_PREF_KEY_THEME = "in.basulabs.shakealarmclock.THEME";
	 ...
	 */
	public static final String SHARED_PREF_KEY_AUTO_SET_TONE = "in.basulabs.shakealarmclock" +
			".AUTO_SET_TONE";
	...
	public static final int PERMISSION_TYPE_NECESSARY = 1;
	 ...
	 */
	public static LocalDateTime getAlarmDateTime(LocalDate alarmDate, LocalTime alarmTime,
	                                     boolean isRepeatOn
	 ...
	 */
	public static final String SHARED_PREF_KEY_NOTIF_CHANNELS_DELETED = "in.basulabs" +
			".shakealarmclock" +
			".NotifChannelsDeleted";
