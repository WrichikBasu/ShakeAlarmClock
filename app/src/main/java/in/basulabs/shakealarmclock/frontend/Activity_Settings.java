...
public class Activity_Settings extends AppCompatActivity implements AdapterView.OnItemSelectedListener, CompoundButton.OnCheckedChangeListener,
	...
	private static final String SAVE_INSTANCE_SNOOZE_LAYOUT_EXPANDED = "in.basulabs.shakealarmclock.frontend.Activity_Settings.SNOOZE_LAYOUT_EXPANDED",
			SAVE_INSTANCE_SHAKE_LAYOUT_EXPANDED = "in.basulabs.shakealarmclock.frontend.Activity_Settings.SHAKE_LAYOUT_EXPANDED",
			SAVE_INSTANCE_IS_SHAKE_ONGOING = "in.basulabs.shakealarmclock.frontend.Activity_Settings.IS_SHAKE_ONGOING";
